...
- treebund-workspace-root :: The most important variable you probably want to configure is
  ~treebund-workspace-root~. This configures where all of the treebund workspaces are going to be
  located on your file system.

  *Default*: =“~/workspaces/”=

- treebund-project-open-function :: This is the function called when a project is opened. You could
...
- treebund-bare-dir :: This is the directory that bare repository get cloned to. The intent is for
  this to be mostly transparent, hence the =.= prefix to make it hidden by default.

  *Default*: =(file-name-concat treebund-workspace-root “.bare”=

- treebund-prefix :: A string used to prefix all branches created with treebund. By default, it's
